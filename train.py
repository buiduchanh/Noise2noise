...
def get_args():
    ...
    parser.add_argument("--target_noise_model", type=str, default="clean,0,50",
...
def main():
    ...
    source_noise_model = get_noise_model(noise_type = args.source_noise_model)
    target_noise_model = get_noise_model(noise_type = args.target_noise_model)
    val_noise_model = get_noise_model(noise_type = args.val_noise_model)
